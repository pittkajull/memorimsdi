...
export default function Moments() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-black py-28">
      ...
      {/* Cahaya hangat */}
      <div className="glow-orb pointer-events-none absolute -left-32 top-1/3 h-[26rem] w-[26rem] rounded-full bg-amber-500/10 blur-3xl"></div>
      <div className="glow-orb pointer-events-none absolute -right-32 bottom-10 h-80 w-80 rounded-full bg-amber-400/5 blur-3xl"></div>
